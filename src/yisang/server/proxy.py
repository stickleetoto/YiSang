...
def _augmentation_message(rendered_context: str) -> str:
    return (
        ...
        "model tool calls when a client tool is needed. Tool arguments MUST "
        "match the provided JSON Schema exactly: do not stringify arrays, "
        "objects, numbers, integers, booleans, or null values.\n\n"
